...
public class E_Array {
	...
	public static void main(String[] args) {
		...
		// +) 참조 데이터 타입은 기본갑이 모두 null
		// cf) null
		//	   : 아무 객체도 참조하지 않음을 나타내는 값 (기본 데이터 타입 사용 X)
		
		// +) Collection Framework의 모든 클래스 내부에서는 캑체 구조만을 다룸
		//	  : 기본 타입 사용 X
		...
		// == ArrayList 생성 ==
		// : ArrayLisst<데이터타입> 변수명 = new ArrayList<>(초기용량);
		...
		// : 초기 용량 미지정 시 - 기분값 10
		// > 해당 용량은 배열 사용 시 담겨있는 요소의 만큼만 측정
