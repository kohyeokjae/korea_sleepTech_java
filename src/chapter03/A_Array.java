...
// - 모든 코드가 클래스 안에서 동작
public class A_Array {	// 클래스 명 == 파일 명 (대문자로 시작)
	// 코드 작성
	...
	public static void main(String[] args) {
		...
		// cf) 참조 자료형 - 주소값 저장
		System.out.println(scores);	// [I@51016012
		
		// == 배열 요소에 접근 ==
		// : 배열명[인덱스 번호]
		// +) 데이터 변경(삽입): 배열명[인덱스 번호] = 데이터 값;
		...
		System.out.println(fruits);	// [Ljava.lang.String;@29444d75
