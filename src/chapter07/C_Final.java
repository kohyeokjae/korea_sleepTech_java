...
class StudentClass {
	private String name;	// 보호 O / 변경될 수 O
	...
	// 필드 주입 방식
	private final int residentNumber = 10;	// 보호 O / 변경될 수 X
	
	// 생성자 주입 방식
	private final String gender; 	// 보호 O / 변경될 수 X
...
public class C_Final {
	...
	public static void main(String[] args) {
		...
		// 단점) 유연성 감소 (상속 X, 오버라이드 X : 그 자체로만 사용 가능)
	}
