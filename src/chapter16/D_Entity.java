...
// DAO(Data Access Objec): 데이터베이스에 접근하는 객체
// Entity: 실제 DB 테이블과 매핑되는 클래스

// 1) DTO
// : 계층 간 데이터 교환을 위해 사용하는 객체
// - 로직을 가지지 않는 순수한 데이터 객체(Getter/Setter만을 가짐)
// - 주로 DB에서 데이터를 가져오거나 통신(프로트엔드)에서 요청/응답 데이터를 담아 전달할 때 사용
