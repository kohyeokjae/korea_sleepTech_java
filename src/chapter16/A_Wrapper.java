...
// cf) 기본 데이터 타입
//     byte, short, int, long, float, double, boolean, char, void(메서드 반환)
...
// : 기본 타임과 해당 타입의 Wrapper 클래스 간의 자동 변환
// - 자바 컴파일러가 자동 처리
...
// 단점:
//      - 객체 생성 과정에서 메모리 생산량 즈아(박싱, 언박싱 과정에서 성능 저화)
...
public class A_Wrapper {
	...
	public static void main(String[] args) {
		...
		// 2) 언박싱
		Integer integerValue = new Integer(15);	// java 9 버전 이하 때 사용
		...
		// new Integer("안녕");	// java.lang.NumberFormatException
		// >> 문자열이 숫자로 변환될 수 없는 경우 NumberFormatException 발생
		
		// intValue(): Integer 객체를 기본 int 타입으로 반환
		int myInt = myInteger.intValue();
		System.out.println(myInt);	// 50
