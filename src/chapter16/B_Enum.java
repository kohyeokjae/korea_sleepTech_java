...
public class B_Enum {
	...
	public static void main(String[] args) {
		...
		System.out.println(Fruits.values());	// [Lchapter16.Fruits;@7a81197d
		...
		CoffeeSize autherSize = CoffeeSize.LARGE;
		System.out.println(autherSize + "'s ml: " + autherSize.getMl() + "ml");
		// LARGE's ml: 400ml
	}
}
