...
// == 1. 특징 ==
// 1) 스트림은 데이터를 소스로부터 연속적으로 처리하는 '파이프 라인'을 구축
...
public class G_Stream {
	...
	public static void main(String[] args) {
		...
		System.out.println(names); // [홍길동, 홍길덩, 홍길당, 홍길둥, 홍길똥]
		...
		// - collect: 요소를 반환하여 컬렉션으로 반환
		// - reduce: 모든 요소를 하나의 값으로 줄임
		// - count: 요소의 개수를 반환

		names.stream()
				.map(name -> name + "님")
				// 문자열.startWith(""): 해당 키워드로 시작하는 문자열일 경우 true 반환
