...
class School {
	...
	class Student {
		...
		public void displayInfo() {
			System.out.println("학교명: " + schoolName + ", 학생 ID: " + 
					studentId + ", 학생 이름: " + studentName);
		}
	}
...
public class B_Inner {
	...
	public static void main(String[] args) {
		School school = new School("한국 초등학교");
		
		// @롬복어노테이션생성자
		// : 필드값 순서대로 매개변수 값을 설정 - 타입 유의!!
		School.Student student1 = school.new Student(1, "홍길동");
		student1.displayInfo();	// 학교명: 한국 초등학교, 학생 이름: 홍길동
		
		// Principal 클래스: 정적 내부 클래스
		// - 외부 클래스 인스턴스 없이 사용 가능
		// >> getInstance() 내부의 new 연산자 사요으로 new 키워드 생략 가능
