...
public class E_Lambda {
	...
	public static void main(String[] args) {
		...
		System.out.println(stringLength.apply("홍길동"));	// 3
		System.out.println(upperString.apply("hello world"));	// HELLO WORLD
		...
		printLength.accept("1234");		// 4
		
		Consumer<String> combindConsumer = printMessage.andThen(printLength);
		combindConsumer.accept("123456"); 	
		// 123456
		// 6
