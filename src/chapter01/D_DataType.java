	...
	public static void main(String[] args) {
		/*
		 	...
		 	2) 참조 타입
		 		...
		 		- 객체, 배열과 같은 메모리의 Heap 영역에 저장된 데이터를 참조
		 */
		...
		byte byteValue = 127;
		int intValue = 1231231223;
		long longValue = 1232131243215123L;
		// >> long 타입은 숫자 뒤에 알파벳 l, L을 써서 표기(대문자 권장)
		
		// 1-2) 문자형: char(2)
		// : 2바이트 크기, 단일 문자만 저장 가능
		// >> 홑따음표(작은따음표)로 표기
		char grade = 'A';
		char lastName = '고';
		// char lastName2 = "고";
		...
		// - double(8바이트 실수)*
		// >> 부동 소수점이 있는 수
		float doller1 = 32.123F; // 데이터값 뒤에 알파벳 f, F 사용
		double doller2 = 32.123;
