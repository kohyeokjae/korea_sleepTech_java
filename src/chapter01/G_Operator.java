...
public class G_Operator {
	...
	public static void main(String[] args) {
		...
		// 전위 증감 연산자 / 후위 증감 연산자
		// 1) 전위 증감 연산자
		// : 값이 먼자 변경되고 나서 계산이 적용
		// - ++변수명, --변수명
		System.out.println(++number); // 1 + 10 (증가) 후 출력
		System.out.println(--number); // -1 + 11 (감소) 후 출력
		...
		System.out.println(number--); // 11 : 출력 후 -1 + 11 (감소)
		System.out.println(number); // 10
		...
		System.out.println("=== 조(삼항) 연산자 ===");
		// 조건식(논리의 값이 반환) ? 조건식이 참인 경우 반환 : 조건식이 거짓인 경우 반환
		
		int age = 27;
		String drink = age > 19 ? "맥주" : "콜라";
		...
		String z = (x % y) == 0 ? "2의 배수입니다" : "2의 배수가 아닙니다.";
