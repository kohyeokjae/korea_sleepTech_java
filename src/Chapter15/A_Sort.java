...
public class A_Sort {
	...
	public static void main(String[] args) {
		...
		// 2) 내림차순 정렬
		// : Comparator 클래스 reverseOrder()
		// 		>> Comparator<T>을 반환하는 메서드
		//		   : 객체 (타임) 간의 비교 (기본 데이터 타입 비교 X)
		Integer[] nums = { 5, 3, 2, 6, 7 };
		...
		// 3) 스트림 API 사용 정렬
		//: 정렬된 결과를 새로운 리스트로 반환
		List<Integer> listNumbers = new ArrayList<Integer>(List.of(8, 2, 5, 4, 1));
		...
		System.out.println(sortedCharacter);	// [Tom, Jerry, Loopy, Pororo]
