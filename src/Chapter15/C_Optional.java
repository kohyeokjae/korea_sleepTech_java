...
public class C_Optional {
	...
	public static void main(String[] args) {
		...
		// Optional<String> optional2 = Optional.of(null);	// java.lang.NullPointerException
		...
		// System.out.println(optional3.get()); 	// java.util.NoSuchElementException
		...
		System.out.println(optional3.orElseGet(() -> "발생시키는 값"));	// 발생시키는 값
