...
import lombok.*; // 롭복 라이브러리 전체 클래스를 import
...
// @RequiredArgsConstructor // - title(필드값)을 매개변수로 가짐
@Builder
class LombokClass {
...
public class H_Lombok {
	...
	public static void main(String[] args) {
		...
		// lombokClass.setAuthor("홍길동");
		// System.out.println(lombokClass);
		
		// LombokClass lombokClass = new LombokClass("신데렐라");
		// lombokClass.setTitle("백설공주");
		// : @Setter는 final 필드에 대해서 메서드 생성 X
		
		LombokClass lombokClass2 = new LombokClass("백설공주", "홍길동");
		
		// System.out.println(lombokClass);	// LombokClass(title=신데렐라, author=null)
		System.out.println(lombokClass2);	// LombokClass(title=백설공주, author=홍길동)
