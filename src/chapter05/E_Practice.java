...
class BaseballPlayer {
	...
	// == 생성자 ==
	// +) 필드값 초기화 & 정적 변수 후위 증가
	BaseballPlayer(String name, double battingAberage, int homeRuns) {
		this.name = name;
		this.battingAverage = battingAberage;
...
public class E_Practice {
	...
	public static void main(String[] args) {
		...
		BaseballPlayer player2 = new BaseballPlayer("홍길둥", 0.305, 20);
		BaseballPlayer player3 = new BaseballPlayer("홍길덩", 0.245, 15);
		BaseballPlayer player4 = new BaseballPlayer("홍길당", 0.295, 12);
		
		System.out.println("총 생성된 선수의 수: " + BaseballPlayer.playerCount);
		// 총 생성된 선수의 수: 4
		
		player2.updateStatus(0.325, 22);
		System.out.println(player2.battingAverage);	// 0.325
		...
		System.out.println(BaseballPlayer.evaluateHomeRun(player2.homeRuns));
	}
