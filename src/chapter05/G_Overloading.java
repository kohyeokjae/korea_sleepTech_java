...
class Restaurant {
	...
	void placeOrder(String dish, String specialReqests) {
		System.out.println(dish + " - " + specialReqests);
	}

	void placeOrder(String dish, int quantity, String specialReqests) {
		System.out.println(dish + " * " + quantity + " - " + specialReqests);
	}
