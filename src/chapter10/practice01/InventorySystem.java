	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			try {
				...
				// Integer.parseInt(A)
				// : A 값을 분석하여 Integer 형태로 변환
				// >> 숫자로 형태로 변경할 수 없는 값이 입력되는 경우 NumberFormatException 예외 발생
				...
				case 2:
					...
					break;
				case 3:
					System.out.println("Enter Serch Keyword");
