...
import chapter10.practice02.repository.InMemoryItemRopository;
...
public class Main {
	...
	public static void main(String[] args) {
		// ItemRepository repository = new InMemoryItemRopository();
		// InventoryService service = new InventoryServiceImpl(repository);
		
		InventoryService inventoryService = new InventoryServiceImpl(new InMemoryItemRopository());
	...
	private static void addItem(InventoryService inventoryService, Scanner sc) {
		...
		System.out.println("Enter Item Quanity: ");
		...
		if (category.equalsIgnoreCase("Electronics")) {
			...
			System.err.println("Invalid category, Item not added");
		}
	}
