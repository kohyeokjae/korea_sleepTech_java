...
public class HealthRecordServiceImpl implements HealthRecordService {
	...
	@Override
	public List<RecordResponseDto> filterRecordsByDagnosis(String diagnosis) {
		List<RecordResponseDto> responseDtos = null;
