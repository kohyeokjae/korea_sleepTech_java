...
class Attendence {	// 출석부는 출석 체크 기능만을 담당
...
public class D_Coupling_Cohesion {
	...
	public static void main(String[] args) {
		...
		StudentCohesion student = new StudentCohesion("홍길동");
		Attendence attendence = new Attendence();
		attendence.checkAttendance(mathTeacher, student);
	}
}
