...
/*
 	...
 	SRP: 단일 책임 원칙
 	OCP: 개방 폐쇄 원칙
 	LSP: 리스코프 치환 원칙 - 자식 클래스는 부모 클래스를 데체할 수 있어야 한다.
 	ISP: 인터페이스 분리 원칙
 	DIP: 의존 역전 원칙 - 클래스 간의 결합을 낮추고, 추상화에 의존해야 한다.
 */
...
public class C_OOP {	
	...
	public static void main(String[] args) {
		...
		Order order2 = new Order("2", 20000);
		Order order3 = new Order("3", 30000);
		Order order4 = new Order("4", 40000);
		Order order5 = new Order("5", 50000);
		...
		orderService2.placeOrder(order5);
	}
}
