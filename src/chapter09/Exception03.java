...
// 1. throw
// : 프로그램 실행 중에 특정 조건에 예외를 직접 발생시킬 때 사용
...
// cf) throw: 메서드 내부에 위치, 예외를 발생시킴, throw new ExceptionType("에외메시지");
