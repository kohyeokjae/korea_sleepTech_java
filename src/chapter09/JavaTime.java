...
public class JavaTime {
	...
	public static void main(String[] args) {
		...
		System.out.println(tommorow);	// 2025-02-20
		...
		System.out.println(now);	// 11:15:31.377094
		...
		System.out.println(restTime);	// 11:50:31.377094
		
		// cf) LocalDateTime 클래스
		//     : 날짜와 시간을 함께 다루는 클래스
		//     > .now(), .of(), .plus~(), .minus~() 사용 가능
		LocalDateTime nowDateTime = LocalDateTime.now();
		System.out.println(nowDateTime); 	// 2025-02-19T11:17:16.258622
		...
		System.out.println(example);	// 2025-02-19T11:22:29.983800
		
		// DateTimeFormatter: LocalDateTime의 날짜/시간 데이터를 원하는 패턴으로 변경
		DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yy-MM-dd HH:mm:ss");
		
		// 변경할 날짜/시간 데이터.format(원하는 포맷 형식)
		System.out.println(example.format(formatter));	// 25-02-19 11:24:45
	}
